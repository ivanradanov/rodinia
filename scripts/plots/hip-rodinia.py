...
hostname_ = hostname
configs = {
    polygeist_no_par_opts: get_conf(2, commit, target='amdgpu'),
    #'PGO 12': get_conf(12, 'eb30eb97f978', 'pgo_opt'),
    polygeist_w_par_opts: get_conf(11, commit, 'pgo_opt', target='amdgpu'),
}
...
plt.savefig(getuniqfn(os.path.join(figures_dir,'{}rodinia-cuda-hip-clang-2-11-comparison'.format(hostname_)), 'pdf'), bbox_inches='tight')
