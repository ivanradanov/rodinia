...
void embedded_fehlberg_7_8(fp timeinst, fp h, fp *initvalu, fp *finavalu, fp *error, fp *parameter, fp *com,
                           ...
                           long long *timecopyin, long long *timecopykernel, long long *timecopyout)
{
    ...
    for (i = 0; i < EQUATIONS; i++)
    {
        initvalu_temp[i] = initvalu[i] + h * (b12_1 * finavalu_temp[0][i] + b12_6 * finavalu_temp[5][i] +
    ...
    {
        finavalu[i] =
            initvalu[i] + h * (c_1_11 * (finavalu_temp[0][i] + finavalu_temp[10][i]) + c6 * finavalu_temp[5][i] +
    ...
    for (i = 0; i < EQUATIONS; i++)
    {
        error[i] = fabs(err_factor *
                        (finavalu_temp[0][i] + finavalu_temp[10][i] - finavalu_temp[11][i] - finavalu_temp[12][i]));
    }
