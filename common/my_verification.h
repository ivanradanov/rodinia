...
#define MY_VERIFY_INT(ARRAY_PTR, SIZE) MY_VERIFY(ARRAY_PTR, SIZE, int, MY_INT_STYLE_EQ, "%d", 0, 0, 0)
#define MY_VERIFY_RAW(ARRAY_PTR, SIZE) MY_VERIFY(ARRAY_PTR, SIZE, char, MY_INT_STYLE_EQ, "%d", 0, 0, 0)
#define MY_VERIFY_CHAR(ARRAY_PTR, SIZE) MY_VERIFY(ARRAY_PTR, SIZE, char, MY_INT_STYLE_EQ, "%d", 0, 0, 0)
#define MY_VERIFY_FLOAT_EXACT(ARRAY_PTR, SIZE)                          \
  MY_VERIFY(ARRAY_PTR, SIZE, float, MY_FP_STYLE_EQ, "%.9g", FLT_MIN, (FLT_EPSILON * 256), FLT_MAX)
#define MY_VERIFY_DOUBLE_EXACT(ARRAY_PTR, SIZE)                         \
  MY_VERIFY(ARRAY_PTR, SIZE, double, MY_FP_STYLE_EQ, "%.17g", DBL_MIN, (DBL_EPSILON * 256), DBL_MAX)
