...
MY_START_CLOCK(hypterm-cuda kernels.cu,0);
...
MY_STOP_CLOCK(hypterm-cuda kernels.cu,0);

MY_START_CLOCK(hypterm-cuda kernels.cu,1);
...
MY_STOP_CLOCK(hypterm-cuda kernels.cu,1);

MY_START_CLOCK(hypterm-cuda kernels.cu,2);
...
MY_STOP_CLOCK(hypterm-cuda kernels.cu,2);
  }
