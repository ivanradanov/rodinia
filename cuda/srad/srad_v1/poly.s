...
)
{
	...
	sub.rn.f32 	%f4, %f13, %f9;
	mul.rn.f32 	%f14, %f2, %f2;
	fma.rn.f32 	%f15, %f1, %f1, %f14;
	fma.rn.f32 	%f16, %f3, %f3, %f15;
	fma.rn.f32 	%f17, %f4, %f4, %f16;
	mul.rn.f32 	%f18, %f9, %f9;
	div.rn.f32 	%f19, %f17, %f18;
	add.rn.f32 	%f20, %f1, %f2;
	add.rn.f32 	%f21, %f20, %f3;
	add.rn.f32 	%f22, %f21, %f4;
	...
	sub.rn.f32 	%f29, %f28, %f7;
	add.rn.f32 	%f30, %f7, 0f3F800000;
	mul.rn.f32 	%f31, %f30, %f7;
