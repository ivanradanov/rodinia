...
MY_START_CLOCK(match-cuda main.cu,0);
  ...
  threads = dim3(M1W);
MY_START_CLOCK(match-cuda main.cu,1);
...
MY_START_CLOCK(match-cuda main.cu,2);
  for (int i = 0; i < repeat; i++) 
  ...
  blocks = dim3(NPTS/M2W);
  threads = dim3(M2W, M2H);
MY_START_CLOCK(match-cuda main.cu,3);
  for (int i = 0; i < repeat; i++) 
  ...
  blocks = dim3(NPTS/M2W);
  threads = dim3(M2W, M2H);
MY_START_CLOCK(match-cuda main.cu,4);
  for (int i = 0; i < repeat; i++) 
...
MY_START_CLOCK(match-cuda main.cu,5);
  for (int i = 0; i < repeat; i++) 
  ...
  blocks = dim3(NPTS/M5W);
  threads = dim3(M5W, M5H);
MY_START_CLOCK(match-cuda main.cu,6);
  for (int i = 0; i < repeat; i++) 
...
MY_START_CLOCK(match-cuda main.cu,7);
  for (int i = 0; i < repeat; i++) 
  ...
  blocks = dim3(NPTS/M7W);
  threads = dim3(M7W, M7H/M7R);
MY_START_CLOCK(match-cuda main.cu,8);
  for (int i = 0; i < repeat; i++) 
...
MY_START_CLOCK(match-cuda main.cu,9);
  for (int i = 0; i < repeat; i++) 
  ...
  blocks = dim3(NPTS/M7W);
  threads = dim3(M7W, M7H/M7R);
MY_START_CLOCK(match-cuda main.cu,10);
  for (int i = 0; i < repeat; i++) 
